...
const PaymentModalBody = ({handleCancel, handleTrial}) => {
  ...
  return (
    <div className="px-20 py-16 text-black rounded-2xl">
      ...
      <div className="border border-primary rounded-2xl p-16 text-xl space-y-3">
        ...
        <p>
          We Charge a Monthly pro-rated for each service you opt into for management. You may opt out at any time.{' '}
        </p>
        ...
        <div className="flex justify-end gap-5 pt-5">
             <button type="button" onClick={handleCancel} className="button text-xl py-3 px-6">Cancel</button>
             <button type="button" onClick={handleTrial} className="button bg-primary text-white capitalize text-xl py-3 px-6">Begin Trial</button>
        </div>
      </div>
    </div>
  );
