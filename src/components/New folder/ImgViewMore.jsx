...
const ImgViewMore = ({ src, alt }) => (
  <div className="relative rounded-xl lg:rounded-3xl overflow-hidden w-full h-[300px] md:h-[400px] lg:h-[420px]  5xl:h-[590px]  mt-10 md:mt-10 lg:mt-0">
    <img
