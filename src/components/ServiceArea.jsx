...
const ServiceArea = () => (
  <div className="">
    ...
    />
    <div className="grid grid-cols-1  sm:grid-cols-[2fr_3fr] lg:gap-x-10 xl:gap-x-14  extra-large:gap-20 h-full w-full lg:my-10 xl:my-20 justify-start items-center">
      <article className="justify-start items-baseline space-y-4 order-last sm:order-first">
